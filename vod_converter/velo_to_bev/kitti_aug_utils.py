...
def camera_to_lidar_box(boxes, V2C=None, R0=None, P2=None):
    ...
    for box in boxes:
        x, y, z, h, w, l, ry = box
        (x, y, z), h, w, l, rz = camera_to_lidar(x, y, z, V2C=V2C, R0=R0,
                                                 P2=P2), h, w, l, -ry - np.pi / 2
...
def lidar_to_camera_box(boxes, V2C=None, R0=None, P2=None):
    ...
    for box in boxes:
        x, y, z, h, w, l, rz = box
        (x, y, z), h, w, l, ry = lidar_to_camera(x, y, z, V2C=V2C, R0=R0,
                                                 P2=P2), h, w, l, -rz - np.pi / 2
...
def center_to_corner_box3d(boxes_center, coordinate='lidar'):
    ...
    for i in range(N):
        ...
        yaw = rotation[2]
        rotMat = np.array([[np.cos(yaw), -np.sin(yaw), 0.0], [np.sin(yaw),
                                                              np.cos(yaw), 0.0], [0.0, 0.0, 1.0]])
...
def complex_yolo_pc_augmentation(lidar, labels, augData):
    ...
    if augData and choice == 0:
        ...
        lidar_center_gt_box3d = box_transform(lidar_center_gt_box3d,
                                              0,
                                              0,
                                              0,
                                              r=angle,
